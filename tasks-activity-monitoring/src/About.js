...
function About() {
    ...
    return (
        <div id='about' style={{ color: color, fontSize: '1.1rem' }}>
            ...
            <p>
                This application allows to make time recordings for different tasks. When application is launched (using "npm start"), user can see main page with three different links. First link - "See all tasks" - leads to the view where user can add new tasks and tags via form and see all exiting tags and filter them. Besides, it is possible to edit task, edit/remove/add tags, change status of the task and delete whole task component. Second link - "Summary" - contains information about task activity time and activity periods. Third link - "About" - shows this page. Fourth link - "Settings" - allows to change color theme and mode of displaying active tasks (multiple or one at a time).
            </p>
            <p>
